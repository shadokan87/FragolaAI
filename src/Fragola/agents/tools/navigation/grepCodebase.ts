...
}).describe('A tool for searching the entire codebase for specific content. Use this when you need to find occurrences of a particular string, function name, or pattern across multiple files. It returns an array of items formatted as "<file_id>:<real_file_path>:<match_count>", allowing you to locate and quantify matches throughout the project.');
